...
<div class='post-details-width'>
  <div class="post-details-global">
    ...
    <div class="post-details-right">
      ...
      <div class="profile">
        <div>
        <a href="{{ route('profile.show', $equipment->user->id)}}">
          <img src="/images/user/{{$equipment->user->image}}" alt="profile-img" class="profile-img">
</a>
        </div>
        <div>
          <p class="published-by">{{ $equipment->user->name }}</p>
      ...
      <hr>
      <!-- description -->
      <p class="post-desc">{{ $equipment->desc }}</p>
      <!--  -->
      <hr>
      <!-- location -->
      <div class="post-flex">
        <img src="{{url('svg/place-post.svg')}}" class='icon-contact' />
        <p class="post-desc">{{ $equipment->location }}</p>
      </div>
      <!--  -->
      <hr>
      <!-- date -->
      <div class="post-flex">
        ...
        <p class="post-desc">{{ $equipment->date }}</p>
      </div>
      <!--  -->
      <hr>
      <!-- price -->
      <div class="post-flex">
        ...
        <p class="post-desc">{{ $equipment->price }}</p>
      </div>
      <!--  -->
      <hr>
      <!-- type -->
      <div class="post-flex">
        ...
        <p class="post-desc">{{ $equipment->type }}</p>
      </div>      
      <!--  -->
      <hr>
      <!-- contact -->
  ...
  <div class="post-comments-global">
    ...
    <!-- ADD COMMENT -->
    <form action="{{ route('equipment-comment.store') }}" enctype="multipart/form-data" method="POST">
      @csrf
      <input type="hidden" id="user_id" value="{{ Auth::user()->id }}" name="user_id">
      <input type="hidden" id="equipment_id" value="{{ $equipment->id }}" name="equipment_id">
