...
<div class="menu-global">
  ...
  <div class="menu-right">
    ...
    <a href="{{ route('ALL-SUPPLIER') }}">All</a>
      ...
      <a href="{{ route('SUGGESTION-SUPPLIER') }}" class="active">Suggestion</a>
      <a href="{{ route('ENTERTAINMENT-SUPPLIER') }}">Entertainment</a>
      <a href="{{ route('CATERING-SUPPLIER') }}">Catering</a>
      <a href="{{ route('SUGGESTION') }}" class="become">Check as a Finder</a>
      @guest
      @if (Route::has('login'))
