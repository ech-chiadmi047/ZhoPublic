...
<div class="menu-global">
  ...
  <div class="menu-right">
    ...
    <a href="{{ route('ALL-SUPPLIER') }}">All</a>
      <a href="{{ route('COMPANY-SUPPLIER') }}">Company</a>
      <a href="{{ route('PLACE-SUPPLIER') }}">Place</a>
      <a href="{{ route('EQUIPMENT-SUPPLIER') }}">Equipment</a>
      <a href="{{ route('SUGGESTION-SUPPLIER') }}">Suggestion</a>
      <a href="{{ route('ENTERTAINMENT-SUPPLIER') }}" class="active">Entertainment</a>
      <a href="{{ route('CATERING-SUPPLIER') }}">Catering</a>
      <a href="{{ route('ENTERTAINMENT') }}" class="become">Check as a Finder</a>
      @guest
      @if (Route::has('login'))
