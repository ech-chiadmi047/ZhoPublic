...
@section('content')
<form id="regForm" action="{{ route('zho-entertainment.store') }}" enctype="multipart/form-data" method="POST">
    @csrf
        ...
        <input type="hidden" id="user_id" value="{{ Auth::user()->id }}" name="user_id">
            ...
            <div>
                ...
                <div class="preferences-flex">
                        <input type="checkbox" id="looking_for" name="looking_for" value="1"
                            style="display: none;">
                        ...
                        <input type="checkbox" id="displaying" name="displaying" value="1"
                            style="display: none;">
