...
<div class='post-details-width'>
  <div class="post-details-global">
    ...
    <div class="post-details-right">
      ...
      <div class="profile">
        <div>
        <a href="{{ route('profile.show', $entertainment->user->id)}}">
          <img src="/images/user/{{$entertainment->user->image}}" alt="profile-img" class="profile-img">
</a>
        </div>
        <div>
          <p class="published-by">{{ $entertainment->user->name }}</p>
      ...
      <hr>
      <!-- description -->
      <p class="post-desc">{{ $entertainment->desc }}</p>
      <!--  -->
      <hr>
      <!-- location -->
      <div class="post-flex">
        <img src="{{url('svg/place-post.svg')}}" class='icon-contact' />
        <p class="post-desc">{{ $entertainment->location }}</p>
      </div>
      <!--  -->
      <hr>
      <!-- date -->
      <div class="post-flex">
        ...
        <p class="post-desc">{{ $entertainment->date }}</p>
      </div>
      <!--  -->
      <hr>
      <!-- price -->
      <div class="post-flex">
        ...
        <p class="post-desc">{{ $entertainment->price }}</p>
      </div>
      <!--  -->
      <hr>
      <!-- type -->
      <div class="post-flex">
        ...
        <p class="post-desc">{{ $entertainment->type }}</p>
      </div>      
      <!--  -->
      <hr>
      <!-- contact -->
  ...
  <div class="post-comments-global">
    ...
    <!-- ADD COMMENT -->
    <form action="{{ route('entertainment-comment.store') }}" enctype="multipart/form-data" method="POST">
      @csrf
      <input type="hidden" id="user_id" value="{{ Auth::user()->id }}" name="user_id">
      <input type="hidden" id="entertainment_id" value="{{ $entertainment->id }}" name="entertainment_id">
