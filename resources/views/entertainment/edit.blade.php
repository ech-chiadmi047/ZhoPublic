  ...
  <div class="post-details-global">
    <div class="post-details-left">
      <div class="slideshow-container">
        ...
        <div class="mySlides">
          <img src="/images/entertainment/{{$image->image}}">
          <form action="{{ route('entertainment-image.destroy', $image->id)}}" method="post">
            @csrf
            @method('DELETE')
    ...
    <div class="post-details-right">
      ...
      <div class="profile">
        ...
        <div>
          ...
          <p class="published-on">{{ $entertainment->created_at }}</p>
        </div>
      </div>
      <!--  -->
      <hr>
      <form action="{{ route('zho-entertainment.update', $entertainment->id) }}" enctype="multipart/form-data" method="POST">
        @method("put")
        @csrf
        <!-- description -->
        ...
        <div class="post-flex">
          ...
          <select name="location" class="edit">
            <option value="{{ $entertainment->location }}" selected>{{ $entertainment->location }}</option>
        ...
        <div class="post-flex">
          ...
          <input id="date" type="date" class="form-control @error('date') is-invalid @enderror" name="date"
            value="{{ $entertainment->date }}" required autocomplete="date" autofocus class="edit">
        </div>
        <!--  -->
        <hr>
        <!-- price -->
        <div class="post-flex">
          ...
          <input id="price" type="number" class="form-control @error('price') is-invalid @enderror" name="price"
            value="{{ $entertainment->price }}" required autocomplete="price" autofocus class="post-desc" class="edit">
        </div>
        <!--  -->
        <hr>
        <!-- type -->
        <div class="post-flex">
          <img src="/svg/{{ PostType()[$entertainment->type]['icon'] }}.svg" class='icon-type' />
          <select name="type" class="edit">
            <option value="{{ $entertainment->type }}" selected>{{ $entertainment->type }}</option>
        ...
        <div class="post-contact">
          <div>
            ...
            <input id="fb" type="text" class="form-control @error('fb') is-invalid @enderror" name="fb" required
              placeholder="Enter your facebook" value="{{ $entertainment->fb }}">
          </div>
          <div>
            ...
            <input id="num" type="tel" class="form-control @error('num') is-invalid @enderror" name="num" required
              placeholder="Enter your phone number" value="{{ $entertainment->num }}">
          </div>
          <div>
            ...
            <input id="insta" type="text" class="form-control @error('insta') is-invalid @enderror" name="insta"
              required placeholder="Enter your instagram" value="{{ $entertainment->insta }}">
          </div>
        </div>
        <!--  -->
        <hr>
