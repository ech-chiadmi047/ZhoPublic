<div class="sidenav">
    <img src="{{url('asset/home/zho-logo.png')}}" alt="logo" class="logo">
    <div class="sidenav-bg">
        @can('Admin')
        <a href="{{ route('dashboard') }}" class="{{ request()->is('dashboard') ? 'active' : ''}}">
            <span class="icon">
                <!-- ICON -->
                <svg viewBox="0 0 1000 1000" data-name="Layer 2" id="Layer_2" xmlns="http://www.w3.org/2000/svg"
                    fill="#000000">
                    ...
                    <g id="SVGRepo_iconCarrier">
                        ...
                        <rect class="cls-1" height="191.23" rx="12" transform="translate(1315.19 621.1) rotate(-180)"
                            width="262.13" x="526.53" y="214.94"></rect>
                    </g>
                </svg>
                <!--  -->
            </span>
        ...
        <a href="{{ route('admin_verification') }}"
            class="{{ request()->is('dashboard/verifications') ? 'active' : ''}}">
            <span class="icon">
                <!-- ICON -->
                <svg viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M23 9L19.8 12.1999L18 10.4M8 15C5.79086 15 4 16.7909 4 19V21H20V19C20 16.7909 18.2091 15 16 15H12M12 3C9.79086 3 8 4.79086 8 7C8 9.20914 9.79086 11 12 11C14.2091 11 16 9.20914 16 7C16 6.27143 15.8052 5.58835 15.4649 5" stroke="#03004d" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
                <!--  -->
            </span>
            <span class="text">Verifications</span>
        </a>
        @endcan
        <a href="{{ route('my_profile') }}" class="{{ request()->is('dashboard/my_profile') ? 'active' : ''}}">
            <span class="icon">
                <!-- ICON -->
                <svg viewBox="0 0 1000 1000" data-name="Layer 2" id="Layer_2" xmlns="http://www.w3.org/2000/svg"
                    fill="#000000">
        ...
        @can('Client')
        <a href="{{ route('my_wishlist') }}" class="{{ request()->is('dashboard/my_wishlist') ? 'active' : ''}}">
            <span class="icon">
                <!-- ICON -->
                <svg viewBox="0 0 1000 1000" data-name="Layer 2" id="Layer_2" xmlns="http://www.w3.org/2000/svg"
                    fill="#000000">
        ...
        <a href="{{ route('my_posts') }}" class="{{ request()->is('dashboard/my_posts') ? 'active' : ''}}">
            <span class="icon">
                <!-- ICON -->
                <svg viewBox="0 0 1000 1000" data-name="Layer 2" id="Layer_2" xmlns="http://www.w3.org/2000/svg"
                    fill="#000000">
        ...
        @endcan
        @can('Admin')
        <a href="{{ route('all_posts') }}" class="{{ request()->is('dashboard/all_posts') ? 'active' : ''}}">
            <span class="icon">
                <!-- ICON -->
                <svg viewBox="0 0 1000 1000" data-name="Layer 2" id="Layer_2" xmlns="http://www.w3.org/2000/svg"
                    fill="#000000">
        ...
        @endcan
        @can('Client')
        <a href="{{ route('contactus') }}" class="{{ request()->is('dashboard/contactus') ? 'active' : ''}}">
            <span class="icon">
                <!-- ICON -->
                <svg viewBox="0 0 1000 1000" data-name="Layer 2" id="Layer_2" xmlns="http://www.w3.org/2000/svg" fill="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><defs><style>.cls-1{fill:none;stroke:#03004d;stroke-linecap:round;stroke-miterlimit:10;stroke-width:22px;}</style></defs><path class="cls-1" d="M787.35,677.72q-.45-4.69-1.37-9.39A103.91,103.91,0,0,0,777.63,643a33.08,33.08,0,0,0-24.71-18.21l-115-21.25c-10.84-1.72-22.4,4.94-29.95,12.92a104.65,104.65,0,0,0-25.69,47.38,6.13,6.13,0,0,1-8,4.34c-112.44-38.44-204.08-128.54-241-247.39a6.1,6.1,0,0,1,3.84-7.55c11.72-4.09,38.58-14.46,49.35-24.34a33,33,0,0,0,10.21-28.74L381.12,244.21a33,33,0,0,0-17.39-25A104.23,104.23,0,0,0,212.11,306c0,5,.06,9.9.22,14.84A487.67,487.67,0,0,0,221,399.18C264.27,623,454.94,781,672.89,791.78c4.77.25,9.54.42,14.35.5A104.28,104.28,0,0,0,787.35,677.72Z"></path><line class="cls-1" x1="328.89" x2="345.34" y1="208.5" y2="336.3"></line><line class="cls-1" x1="787.35" x2="658.91" y1="677.72" y2="653.67"></line><line class="cls-1" x1="477.76" x2="629.24" y1="522" y2="381.21"></line><line class="cls-1" x1="553.05" x2="478.34" y1="518.25" y2="522.07"></line><line class="cls-1" x1="477" x2="486.27" y1="520.62" y2="446.4"></line></g></svg>
                <!--  -->
            </span>
            <span class="text">Contact us</span>
        </a>
        <a href="{{ route('my_messages') }}" class="{{ request()->is('dashboard/my_messages') ? 'active' : ''}}">
            <span class="icon">
                <!-- ICON -->
                <svg viewBox="0 0 1000 1000" data-name="Layer 2" id="Layer_2" xmlns="http://www.w3.org/2000/svg"
                    fill="#000000">
        ...
        @endcan
        @can('Admin')
        <a href="{{ route('all_messages') }}" class="{{ request()->is('dashboard/all_messages') ? 'active' : ''}}">
            <span class="icon">
                <!-- ICON -->
                <svg viewBox="0 0 1000 1000" data-name="Layer 2" id="Layer_2" xmlns="http://www.w3.org/2000/svg"
                    fill="#000000">
