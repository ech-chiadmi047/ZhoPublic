...
<div class='post-details-width'>
    ...
    <div class="post-details-right">
      ...
      <div class="profile">
        ...
        <a href="{{ route('profile.show', $suggestion->user->id)}}">
          <img src="/images/user/{{$suggestion->user->image}}" alt="profile-img" class="profile-img">
</a>
        </div>
        <div>
          <p class="published-by">{{ $suggestion->user->name }}</p>
      ...
      <hr>
      <!-- description -->
      <p class="post-desc">{{ $suggestion->desc }}</p>
      <!--  -->
      <hr>
      <!-- location -->
      <div class="post-flex">
        <img src="{{url('svg/place-post.svg')}}" class='icon-contact' />
        <p class="post-desc">{{ $suggestion->location }}</p>
      </div>
      <!--  -->
      <hr>
      <!-- date -->
      <div class="post-flex">
        ...
        <p class="post-desc">{{ $suggestion->date }}</p>
      </div>
      <!--  -->
      <hr>
      <!-- price -->
      <div class="post-flex">
        ...
        <p class="post-desc">{{ $suggestion->price }}</p>
      </div>
      <!--  -->
      <hr>
      <!-- type -->
      <div class="post-flex">
        ...
        <p class="post-desc">{{ $suggestion->type }}</p>
      </div>
      <!--  -->
      <hr>
      <!-- contact -->
  ...
  <div class="post-comments-global">
    ...
    <!-- ADD COMMENT -->
    <form action="{{ route('suggestion-comment.store') }}" enctype="multipart/form-data" method="POST">
      @csrf
      <input type="hidden" id="user_id" value="{{ Auth::user()->id }}" name="user_id">
      <input type="hidden" id="suggestion_id" value="{{ $suggestion->id }}" name="suggestion_id">
