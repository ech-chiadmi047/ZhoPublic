...
<div class='post-details-width'>
  <div class="post-details-global">
    ...
    <div class="post-details-right">
      ...
      <div class="profile">
        <div>
        <a href="{{ route('profile.show', $place->user->id)}}">
          <img src="/images/user/{{$place->user->image}}" alt="profile-img" class="profile-img">
</a>
        </div>
        <div>
          <p class="published-by">{{ $place->user->name }}</p>
      ...
      <hr>
      <!-- description -->
      <p class="post-desc">{{ $place->desc }}</p>
      <!--  -->
      <hr>
      <!-- location -->
      <div class="post-flex">
        <img src="{{url('svg/place-post.svg')}}" class='icon-contact' />
        <p class="post-desc">{{ $place->location }}</p>
      </div>
      <!--  -->
      <hr>
      <!-- date -->
      <div class="post-flex">
        ...
        <p class="post-desc">{{ $place->date }}</p>
      </div>
      <!--  -->
      <hr>
      <!-- price -->
      <div class="post-flex">
        ...
        <p class="post-desc">{{ $place->price }}</p>
      </div>
      <!--  -->
      <hr>
      <!-- type -->
      <div class="post-flex">
        ...
        <p class="post-desc">{{ $place->type }}</p>
      </div>
      <!--  -->
      <hr>
      <!-- contact -->
  ...
  <div class="post-comments-global">
    ...
    <!-- ADD COMMENT -->
    <form action="{{ route('place-comment.store') }}" enctype="multipart/form-data" method="POST">
      @csrf
      <input type="hidden" id="user_id" value="{{ Auth::user()->id }}" name="user_id">
      <input type="hidden" id="place_id" value="{{ $place->id }}" name="place_id">
