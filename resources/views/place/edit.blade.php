  ...
  <div class="post-details-global">
    <div class="post-details-left">
      <div class="slideshow-container">
        ...
        <div class="mySlides">
          <img src="/images/place/{{$image->image}}">
          <form action="{{ route('place-image.destroy', $image->id)}}" method="post">
            @csrf
            @method('DELETE')
    ...
    <div class="post-details-right">
      ...
      <div class="profile">
        ...
        <div>
          ...
          <p class="published-on">{{ $place->created_at }}</p>
        </div>
      </div>
      <!--  -->
      <hr>
      <form action="{{ route('zho-place.update', $place->id) }}" enctype="multipart/form-data" method="POST">
        @method("put")
        @csrf
        <!-- description -->
        ...
        <div class="post-flex">
          ...
          <select name="location" class="edit">
            <option value="{{ $place->location }}" selected>{{ $place->location }}</option>
        ...
        <div class="post-flex">
          ...
          <input id="date" type="date" class="form-control @error('date') is-invalid @enderror" name="date"
            value="{{ $place->date }}" required autocomplete="date" autofocus class="edit">
        </div>
        <!--  -->
        <hr>
        <!-- price -->
        <div class="post-flex">
          ...
          <input id="price" type="number" class="form-control @error('price') is-invalid @enderror" name="price"
            value="{{ $place->price }}" required autocomplete="price" autofocus class="post-desc" class="edit">
        </div>
        <!--  -->
        <hr>
        <!-- type -->
        <div class="post-flex">
          <img src="/svg/{{ PostType()[$place->type]['icon'] }}.svg" class='icon-type' />
          <select name="type" class="edit">
            <option value="{{ $place->type }}" selected>{{ $place->type }}</option>
        ...
        <div class="post-contact">
          <div>
            ...
            <input id="fb" type="text" class="form-control @error('fb') is-invalid @enderror" name="fb" required
              placeholder="Enter your facebook" value="{{ $place->fb }}">
          </div>
          <div>
            ...
            <input id="num" type="tel" class="form-control @error('num') is-invalid @enderror" name="num" required
              placeholder="Enter your phone number" value="{{ $place->num }}">
          </div>
          <div>
            ...
            <input id="insta" type="text" class="form-control @error('insta') is-invalid @enderror" name="insta"
              required placeholder="Enter your instagram" value="{{ $place->insta }}">
          </div>
        </div>
        <!--  -->
        <hr>
