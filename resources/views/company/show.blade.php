...
<div class='post-details-width'>
  <div class="post-details-global">
    ...
    <div class="post-details-right">
      ...
      <div class="profile">
        <div>
        <a href="{{ route('profile.show', $company->user->id)}}">
          <img src="/images/user/{{$company->user->image}}" alt="profile-img" class="profile-img">
        </a>
        </div>
        <div>
          <p class="published-by">{{ $company->user->name }}</p>
      ...
      <hr>
      <!-- description -->
      <p class="post-desc">{{ $company->desc }}</p>
      <!--  -->
      <hr>
      <!-- location -->
      <div class="post-flex">
        <img src="{{url('svg/place-post.svg')}}" class='icon-contact' />
        <p class="post-desc">{{ $company->location }}</p>
      </div>
      <!--  -->
      <hr>
      <!-- date -->
      <div class="post-flex">
        ...
        <p class="post-desc">{{ $company->date }}</p>
      </div>
      <!--  -->
      <hr>
      <!-- price -->
      <div class="post-flex">
        ...
        <p class="post-desc">{{ $company->price }}</p>
      </div>
      <!--  -->
      <hr>
      <!-- type -->
      <div class="post-flex">
        ...
        <p class="post-desc">{{ $company->type }}</p>
      </div>
      <!--  -->
      <hr>
      <!-- participant -->
      ...
      <div class="post-flex">
        <p class="post-desc">{{ $company->participantDesc }}</p>
      </div>
      <hr style="width: 94%;margin-left: 3% !important;">
      <div class="post-flex">
        <p class="post-desc">Age : {{ $company->participantAge }}</p>
      </div>
      <hr style="width: 94%;margin-left: 3% !important;">
      <div class="post-flex">
        <p class="post-desc">Gender : {{ $company->participantGender }}</p>
      </div>
      <!--  -->
      <hr>
      <!-- contact -->
  ...
  <div class="post-comments-global">
    ...
    <!-- ADD COMMENT -->
    <form action="{{ route('company-comment.store') }}" enctype="multipart/form-data" method="POST">
      @csrf
