...
@section('content')
<form id="regForm" action="{{ route('zho-company.store') }}" enctype="multipart/form-data" method="POST">
    @csrf
    <div class="form-flex-column">
        ...
        <div class="tab">
            <div>
                <h3 class="form-title">Give us more details !</h3>
            </div>
            <div>
                <div class="preferences-block">
                    <div class="inputs">
        ...
        <div class="tab">
            <div>
                <h3 class="form-title">Who do you want to share this event with ?</h3>
            </div>
            <div>
                <div class="preferences-block">
                    <div class="inputs">
                        ...
                        <input id="participantAge" type="number" class="form-control @error('participantAge') is-invalid @enderror"
                            name="participantAge" value="18" max="100" min="15" required autocomplete="price" autofocus>
                    ...
                    <div class="inputs">
                        <p>Describe them :</p>
                        <textarea id="participantDesc" class="form-control @error('participantDesc') is-invalid @enderror" name="participantDesc"
                            required autofocus>
                        </textarea>

                        @error('participantDesc')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                        @enderror
        ...
        <div class="tab">
            <div>
                <h3 class="form-title">How can they contact you ?</h3>
            </div>
            <div>
                <div class="preferences-block">
                    <div class="inputs">
                        <p style="margin-bottom: 1vw !important;">Contact :</p>
