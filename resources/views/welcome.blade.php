...
<div class="w90">
  <div class="closer-look">
    ...
    <div class="card">
      ...
      <img src="{{url('asset/home/company-tk1.png')}}" class='img-card' />
      <h3 class="card-type">Equipment</h3>
      <h3 class="card-title">This is a title</h3>
      <p class="price">Needed money for the activity : PRICE</p>
      <a href=""><button class="card-btn">More details</button></a>
    </div>
    <!-- ----- -->
  </div>
</div>
