...
<div class='post-details-width'>
  <div class="post-details-global">
    <div class="post-details-left">
      <div class="slideshow-container">
        ...
        <div class="mySlides">
          ...
          <form action="{{ route('catering-image.destroy', $image->id)}}" method="post">
            @csrf
            @method('DELETE')
    ...
    <div class="post-details-right">
      ...
      <!--  -->
      <hr>
      <form action="{{ route('zho-catering.update', $catering->id) }}" enctype="multipart/form-data" method="POST">
        @method("put")
        @csrf
        <!-- description -->
        ...
        <div class="post-flex">
          ...
          <select name="location" class="edit">
            <option value="{{ $catering->location }}" selected>{{ $catering->location }}</option>
        ...
        <div class="post-flex">
          ...
          <input id="date" type="date" class="form-control @error('date') is-invalid @enderror" name="date"
            value="{{ $catering->date }}" required autocomplete="date" autofocus class="edit">
        </div>
        <!--  -->
        <hr>
        <!-- price -->
        <div class="post-flex">
          ...
          <input id="price" type="number" class="form-control @error('price') is-invalid @enderror" name="price"
            value="{{ $catering->price }}" required autocomplete="price" autofocus class="post-desc" class="edit">
        </div>
        <!--  -->
        <hr>
        <!-- type -->
        <div class="post-flex">
          ...
          <select name="type" class="edit">
            <option value="{{ $catering->type }}" selected>{{ $catering->type }}</option>
        ...
        <div class="post-contact">
          <div>
            ...
            <input id="fb" type="text" class="form-control @error('fb') is-invalid @enderror" name="fb" required
              placeholder="Enter your facebook" value="{{ $catering->fb }}">
          </div>
          <div>
            ...
            <input id="num" type="tel" class="form-control @error('num') is-invalid @enderror" name="num" required
              placeholder="Enter your phone number" value="{{ $catering->num }}">
          </div>
          <div>
            ...
            <input id="insta" type="text" class="form-control @error('insta') is-invalid @enderror" name="insta"
              required placeholder="Enter your instagram" value="{{ $catering->insta }}">
          </div>
        </div>
        <!--  -->
        <hr>
