...
<div class="profile-width">
    <div class="profile-global">
        ...
        <div class="profile-right">
            ...
            <hr>
            <!-- description -->
            <p class="profile-desc">{{$user->desc}}</p>
            <!--  -->
            <hr>
            <!-- location -->
            <p class="profile-desc">Age : {{$user->age}}</p>
            <!--  -->
            <hr>
            <!-- location -->
            <p class="profile-desc">Gender : {{ $user->gender }}</p>
            <!--  -->
            <hr>
            <!-- contact -->
            <div class="profile-contact">
                <div>
                    ...
                    <p class="profile-desc">{{$user->fb}}</p>
                </div>
                <div>
                    <img src="{{url('svg/wtsauth.svg')}}" class='icon-profile' />
                    <p class="profile-desc">{{$user->num}}</p>
                </div>
                <div>
                    <img src="{{url('svg/instaauth.svg')}}" class='icon-profile' />
                    <p class="profile-desc">{{$user->insta}}</p>
                </div>
            </div>
